...
function eDefUp (bURL, fURL, type) {
  var E = editor.active, T = E.textArea, P = T.id;
  
  window.open(bURL+'?id='+P,"Загрузка картинок","height=250,width=445,left=300,top=200");
}

function eDefUp2 (bURL, fURL, type) {
  var E = editor.active, T = E.textArea, P = T.id;
  
  window.open(bURL+'?id='+P,"Загрузка файлов","height=250,width=445,left=300,top=200");
}
